...
namespace IOT_Tree_MVC5.Models
{
    public class PointFunction
    {
        ...
        private double DegToRad(double B)
        {
            return B * Math.PI / 180;
        }

        public PointItem vn2000_2_blwgs84(double x, double y)
        {
            double[] num = xyvn2000_2_blwgs84(x, y, 107, 45, 6);
            return new PointItem(num[0], num[1]);
        }

        #region Thư viện chuyển đổi tọa độ
